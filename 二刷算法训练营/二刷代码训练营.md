...
[求两个数组交集 (opens new window)](https://leetcode.cn/problems/intersection-of-two-arrays/)
...
2.用的find,求解思路：一个数组中元素能够在hash中找到，就将这个元素添加到result（hash)中.
