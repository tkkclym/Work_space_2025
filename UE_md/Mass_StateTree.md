...
![全局变量计算需求值](..\Snipaste\全局变量计算需求值.png)
...
![全局任务重置吃饭需求累计时间完美解决1](..\Snipaste\全局任务重置吃饭需求累计时间完美解决1.png)
...
![状态树Task的类默认设置](..\Snipaste\状态树Task的类默认设置.png)
...
![状态进入条件的后续处理](..\Snipaste\状态进入条件的后续处理.png)
...
![状态树。备用转换](..\Snipaste\状态树。备用转换.png)
